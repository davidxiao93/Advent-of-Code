...
class SnailfishNumber:
    ...
    def copy(self) -> SnailfishNumber:
        return SnailfishNumber(self.e.copy())
...
candidates = [(a.copy(), b.copy()) for a in snailfish_numbers for b in snailfish_numbers if a is not b]

magnitudes = [(c[0] + c[1]).magnitude() for c in candidates]
