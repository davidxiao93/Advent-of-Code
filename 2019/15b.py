...
"""
time taken to fill up the whole place is equivalent to the longest non-cyclic path starting from 
the oxygen generator
"""

def find_longest_path_from(start: Point) -> int:
    places_to_explore = {
        0: { start }
    }
    seen_places = set()
...
print(find_longest_path_from(target))
