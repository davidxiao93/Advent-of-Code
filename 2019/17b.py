...
"""
With the image, and assuming you can only go straight at intersections,
then a path can be counted. 
This path is fortunately easily split up into 3 parts
--------------------
L 4 R 8 L 6 L 10 
...
function_a = "L,4,R,8,L,6,L,10"
function_b = "L,6,R,8,R,10,L,6,L,6"
function_c = "L,4,L,4,L,10"


int_codes[0] = 2 # wake the bugger up
c = Computer(int_codes)
for s in [main_routine, function_a, function_b, function_c, "n"]:
    for char in s:
        c.put_input(ord(char))
    c.put_input(ord("\n"))
