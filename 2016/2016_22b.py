...
"""
Once it is in a state with 
. _ G
. . .
then converting that into 
_ G .
. . .
takes 5 steps

Therefore, the real task is to move the _ to the left of G

"""

# check if it is safe to simplify in the same way that
...
for y in range(y_size):
    for x in range(x_size):
        ...
        if size_grid[p] > threshold:
            continue
        if used_grid[p] > max_used:
            max_used = used_grid[p]
